        ...
        <div class="max-w-screen-xl mx-auto">
          ...
          <div class="flex gap-2 sm:gap-3 overflow-x-auto pb-2 scrollbar-hide -mx-3 sm:-mx-4 px-3 sm:px-4">
            <button
              ...
              :key="sport.id"
              class="flex-shrink-0 flex flex-col items-center gap-1 sm:gap-2 px-4 sm:px-5 py-3 sm:py-3.5 rounded-[14px] border transition-all duration-200 min-w-[70px] sm:min-w-[80px]"
