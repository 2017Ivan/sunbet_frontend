<!-- components/skeletons/SportsPageSkeleton.vue -->
<template>
  <SkeletonLoader>
    <div class="min-h-screen bg-[#f8fafc] pb-10">
      <!-- Sports Filter Tabs Skeleton -->
      ...
      <!-- Sports Content Skeleton -->
      <div class="max-w-7xl mx-auto mt-3 px-2">
        <!-- League 1 -->
        <div class="mb-4">
          <div class="sticky top-12 z-10 py-2 pl-1 bg-[#f8fafc]">
            ...
            <div class="bg-white py-3 px-2 border-b border-gray-200">
              <div class="flex items-center justify-between">
                <div class="flex-1">
                  ...
                  <div class="h-4 w-38 bg-gray-200 rounded mb-1"></div>
        ...
        <!-- No Matches Skeleton (hidden by default) -->
        <div class="hidden text-center py-12">
          ...
          <div class="h-3 w-64 bg-gray-200 rounded mx-auto mt-1"></div>
        </div>
      </div>
    </div>
  </SkeletonLoader>
